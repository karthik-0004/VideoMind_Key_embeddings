...
export const StudyRoom = () => {
    ...
    const [fastPdfMode, setFastPdfMode] = useState(() => {
        try {
            const saved = localStorage.getItem('videomind_fast_pdf_mode');
    ...
    useEffect(() => {
        try {
            localStorage.setItem('videomind_fast_pdf_mode', fastPdfMode ? '1' : '0');
        } catch {}
    }, [fastPdfMode]);
                ...
                <div className="topbar">
                    ...
                    <div className="sr-top-r">
                        ...
                        <button
                            ...
                            onClick={() => setFastPdfMode((v) => !v)}
                            title="Toggle quick PDF mode"
                            style={{ minWidth: '72px', width: 'auto', padding: '0 10px', fontSize: '0.68rem' }}
                        >
